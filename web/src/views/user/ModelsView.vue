          ...
          <table class="price-table" v-if="currentModels.length">
            ...
            <tbody>
              <tr v-for="model in currentModels" :key="model.model">
                ...
                <td>
                  <span class="price-tag input">{{ model.currency === 'CNY' ? '¥' : '$' }}{{ model.input_price.toFixed(2) }}{{ t('common.perMillion') }}</span>
                </td>
                <td>
                  <span class="price-tag output">{{ model.currency === 'CNY' ? '¥' : '$' }}{{ model.output_price.toFixed(2) }}{{ t('common.perMillion') }}</span>
                </td>
                <td>
                  <span class="price-tag cache-create">{{ model.currency === 'CNY' ? '¥' : '$' }}{{ model.cache_create_price.toFixed(2) }}{{ t('common.perMillion') }}</span>
                </td>
                <td>
